...
const generateImage = {
    /**
     * 
     * @param {string} auth - The authentication object.
     * @param {string} presentationId - The presentation ID.
     * @param {string} pageObjectId - The page object ID.
     * @param {number} maxRetries - The maximum number of retries.
     * @returns {string} - The base64 image.
     */
  google: async function(auth, presentationId, pageObjectId, maxRetries = 3) {
